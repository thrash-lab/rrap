...
setup(name='rrap',
      ...
      zip_safe=False,
      data_files=[("tests/reference", ["tests/reference/HTCC1062.fasta", "tests/reference/lambda_virus.fa"]),
                  ...
                  ("tests/output/bam/val", ["tests/output/bam/val/ERR864077.bam", "tests/output/bam/val/ERR864077.bam.bai",
                                             ...
                                             "tests/output/bam/val/reads.bam", "tests/output/bam/val/reads.bam.bai"]),
                  ...
                  ("tests/output/stats/val", ["tests/output/stats/val/ERR864077.bam.stats", "tests/output/stats/val/SRR11803378.bam.stats",
                                               "tests/output/stats/val/reads.bam.stats"])])
